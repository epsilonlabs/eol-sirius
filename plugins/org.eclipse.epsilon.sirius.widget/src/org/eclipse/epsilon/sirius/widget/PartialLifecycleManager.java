...
private EEFCustomWidgetDescription description;
	...
	public PartialLifecycleManager(EEFCustomWidgetDescription controlDescription,
	...
	protected void createMainControl(Composite parent, IEEFFormContainer formContainer) {	
		...
		this.controller = new PartialViewerController(description, variableManager, interpreter,
				editingContextAdapter, widget);
